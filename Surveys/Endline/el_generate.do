...
replace int_ben1_correct = "Professional development" if int_ben1=="Apprentissage des processus d'exportation"
replace int_ben1_correct = "Professional development" if int_ben1=="Apprentissage pour diriger une entreprise : marketing"
replace int_ben2_correct = "Professional development" if int_ben2=="Apprentissage"
replace int_ben2_correct = "Professional development" if int_ben2=="Apprenez beaucoup de choses sur les techniques"
replace int_ben3_correct = "Professional development" if int_ben3=="Expériences liées aux visites, possibilité de faire des analyses / comparaisons / évaluations des produits par rapport aux secteurs"
replace int_ben3_correct = "Professional development" if int_ben3=="Les formations"
replace int_ben3_correct = "Professional development" if int_ben3=="Les conseils et l'encadrement en général"
replace int_ben3_correct = "Professional development" if int_ben3=="Il y a des méthodes de gestion et de travail. Énergie positive dans le consortium"
replace int_ben1_correct = "Professional development" if int_ben1=="Projet et expériences"
...
replace int_ben1_correct = "Personal development" if int_ben1=="Travaille sur vous-même"
replace int_ben1_correct = "Personal development" if int_ben1=="Communication entre eux"
replace int_ben2_correct = "Personal development" if int_ben2=="Travaille en équipe "
replace int_ben1_correct = "Personal development" if int_ben1=="Apprentissage mutuel entre eux"
...
replace int_ben1_correct = "Personal development" if int_ben1=="Apprendre comment gérer les conflits"
...
replace int_ben1_correct = "Network" if int_ben1=="Échange"
replace int_ben1_correct = "Network" if int_ben1=="réseaux"
replace int_ben1_correct = "Network" if int_ben1=="Énergie entre les chefs d'entreprise"
replace int_ben1_correct = "Network" if int_ben1=="Collaboration avec d'autres chefs d'entreprise"
...
replace int_ben1_correct = "Network" if int_ben1=="Les connaissances et les relations avec d'autres entrepreneures"
replace int_ben1_correct = "Network" if int_ben1=="echange d'expériences"
replace int_ben1_correct = "Network" if int_ben1=="Elle a rencontré des gens et établi des relations avec les membres du consortium"
replace int_ben1_correct = "Network" if int_ben1=="Pour connaître de nouvelles personnes"
replace int_ben1_correct = "Network" if int_ben1=="Nouveaux contacts, conventions avec d'autres entreprises"
replace int_ben1_correct = "Network" if int_ben1=="Partage d'informations"
replace int_ben3_correct = "Network" if int_ben3=="collaboration"
replace int_ben1_correct = "Network" if int_ben1=="Mutualisation des moyens"
replace int_ben3_correct = "Network" if int_ben3=="Les échanges d’expériences entre les membres du consortium"
replace int_ben1_correct = "Network" if int_ben1=="Les entrepreneurs deviennent partenaires"
replace int_ben1_correct = "Network" if int_ben1=="Profit commun"
replace int_ben1_correct = "Network" if int_ben1=="Network (réseau)"
replace int_ben3_correct = "Network" if int_ben3=="partage d'expérience"
replace int_ben1_correct = "Network" if int_ben1=="Échanges d'informations"
...
replace int_ben2_correct = "Network" if int_ben2=="échange des idées"
...
replace int_ben2_correct = "Network" if int_ben2=="esprit d équipe et collaboration"
replace int_ben_autres_correct = "Network" if int_ben_autres=="à travers le consortium elle commencée de travailler ensemble"
...
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="Égoïsme"
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="communication difficile au début pour créer un lien social et professionnel entre elles  "
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="gère quelque conflits "
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="jalousie"
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="manque de communication"
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="jalousie entre les membres du consortium"
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="manque de communication et coordination entre les membres de consortium"
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="conflit entre les membres" 
replace int_incv1_correct = "Personnal Conflicts " if  int_incv1_correct=="jalousi" 
...
replace int_incv1_correct = "Diversity of members" if  int_incv1_correct=="Notre diversité nous a fait perdre beaucoup de temps et d'énergie pour fixer la meilleure stratégie pour le GIE ==&gt; cumul beaucoup de retard sur ma propre entreprise (voir même une stagnation pendant une longue période)"
replace int_incv3_correct = "Diversity of members" if  int_incv3_correct=="Esprit d un manager n accepte  pas l innovation mène à l exclusion"
replace int_incv2_correct = "Diversity of members" if  int_incv2_correct=="Absence d’ethique de travail par quelques membres"
replace int_incv1_correct = "Diversity of members" if  int_incv1_correct=="manque de communication et coordination entre les membres de consortium"
...
replace int_incv1_correct = "Individual Workload" if  int_incv1_correct=="le temps alloué au consortium au détriments de son propre entreprise"
replace int_incv1_correct = "Individual Workload" if  int_incv1_correct=="perte d'argent"
replace int_incv2_correct = "Individual Workload" if  int_incv2_correct=="Engagement moral"
replace int_incv2_correct = "Individual Workload" if  int_incv2_correct=="Il y'a beaucoup de charge de travail "
...
replace int_incv1_correct = "Program implementation" if  int_incv1_correct=="Perte du temps (abscence de stratégie claire)"
replace int_incv_autres_correct = "Program implementation" if  int_incv_autres_correct=="La GIZ a pris des décisions critiquées dans le processus de sélection des membres du consortium, ce qui a engendré des problèmes dans tous les GIE.  Critères de sélection flous ou non transparents. Manque d'évaluation des capacités, de la maturité et des engagements des membres des GIE."
replace int_incv3_correct = "Program implementation" if  int_incv3_correct=="les procédures s rigide"
replace int_incv_autres_correct = "Program implementation" if  int_incv_autres_correct=="manque de financement" 
