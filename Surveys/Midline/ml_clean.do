...
*   9) 		Remove observations for incomplete entries									 
*																	  													      
...
lab var id_ident "Confirmation de l'identité du répondant"
lab var ident2 "Identifcation de l'entreprise"
lab var firmname_change "Le nouveau nom de l'entreprise"
lab var formation "Participation aux rencontres consortia"
lab var ident_nouveau_personne "Identification de la nouvelle personne"
lab var ident_base_respondent "Identification du répondant"
lab var ident_repondent_position "Position du répondant"

		* Section exchange of ideas and innovation
lab var inno_types "Modifications durant l'année 2022"

lab var inno_produit "Modification significative du produit principal "
lab var inno_process "Modification significative des processus de production"
lab var inno_lieu "Modification significative de l'organisation du lieu de travail"
lab var inno_commerce "Modification significative de la commercialisation de votre produit"
lab var inno_aucune "Aucune modification de ce type en 2022 derniers mois."

lab var inno_mot "Motivation de l'innovation"	

lab var inno_mot_idee "Idée personnelle"
lab var inno_mot_cont "Contact d'affaires"
lab var inno_mot_cons "Grâce à un échange avec un(e) consultant(e)/expert(e)"
lab var inno_mot_eve "Suite à un événement"
lab var inno_mot_emp "Grâce à un échange avec un(e) employé(e)"
lab var inno_mot_test "Un test de conformité avec une norme, règlement technique ou pour une certification."
lab var inno_mot_autre "Autre (à préciser)"
