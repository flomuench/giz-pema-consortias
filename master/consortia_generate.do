...
egen eri = rowmean(temp_exprep_normez temp_exp_pra_foirez temp_exp_pra_sciz temp_exp_pra_rexpz temp_exp_pra_ciblez temp_exp_pra_missionz temp_exp_pra_douanez temp_exp_pra_planz temp_exp_pra_ventz), missing			
...
egen mpi = rowmean(temp_man_fin_per_indz temp_man_fin_per_quaz temp_man_fin_per_stoz temp_man_fin_per_empz temp_man_fin_per_livz temp_man_fin_pra_budz temp_man_fin_pra_disz temp_man_hr_objz temp_man_hr_feedz temp_man_pro_anoz temp_man_fin_enrz temp_man_fin_profitz temp_man_fin_perz temp_man_ind_awaz temp_man_hr_proz temp_man_fin_numz temp_man_fin_per_proz temp_man_fin_per_frez temp_man_fin_pra_proz), missing // added at midline: man_ind_awa man_fin_per_fre instead of man_fin_per, man_hr_feed, man_hr_pro
...
gen profit_pct = .
	...
	sum profit if surveyround == 3 & !inlist(profit, -777, -888, -999, , 999, 888, 777, 1234, .)
...
local ys "employes_w99 car_empl1_w99 car_empl2_w99 ca_w99 ca_exp_w99 sales_w99 profit_w99 exp_inv_w99 profit_2024_w99 employes_w95 car_empl1_w95 car_empl2_w95 ca_w95 ca_exp_w95 sales_w95 profit_w95 exp_inv_w95 profit_2024_w95" // add at endline: exp_pays_w99
