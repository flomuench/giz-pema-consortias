	...
	syntax varlist(min=1 numeric), GENerate(string)
		...
		* Put all regressions into one table
		...
		esttab `regressions' using "rt_`generate'.tex", replace ///
				...
				posthead("\hline \\ \multicolumn{10}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				mtitles("`1'" "`2'" "`3'" "`4'" "`5'" "`6'") ///
				label b(3) se(3) ///
				star(* 0.1 ** 0.05 *** 0.01) ///
