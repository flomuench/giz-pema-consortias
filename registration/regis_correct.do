...
export excel id_plateforme needs_check questions_needing_check commentairesequipegiz commentairesequipemsb  semaine etat programme treatment rg_nom_rep rg_position_rep rg_telrep rg_emailrep rg_telpdg rg_emailpdg presence_enligne rg_siteweb rg_media firmname rg_adresse codepostal id_admin id_admin_correct date_created rg_age rg_legalstatus rg_codedouane rg_matricule rg_fte rg_fte_femmes rg_capital autres ca_2018 ca_exp2018 ca_2019 ca_exp2019 ca_2020 ca_exp2020 moyenneca moyennecaexport conditioncaetcaexport conditioncaoucaexport moyen_com rg_confidentialite rg_partage_donnees rg_enregistrement_coordonnees dateinscription commentairesequipegiz commentairesequipemsb date_creation_string date_inscription_string dup_emailpdg dup_firmname subsector rg_gender_rep rg_gender_pdg rg_resident rg_produitexp rg_intention rg_oper_exp rg_expstatus ca_mean ca_exp_mean exp_share2018 exp_share2019 exp_share2020 mean_exp_share difca ca_eligible eligible eligible_sans_matricule eligible_intention eligible_presence_enligne using "fiche_correction", firstrow(variables)
